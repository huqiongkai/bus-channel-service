...
public class QueryBusReq implements org.apache.thrift.TBase<QueryBusReq, QueryBusReq._Fields>, java.io.Serializable, Cloneable, Comparable<QueryBusReq> {
  ...
  private static final org.apache.thrift.protocol.TField DEST_STATION_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("destStationName", org.apache.thrift.protocol.TType.STRING, (short)8);
   ...
   * 到达车站名称
   */
  public String destStationName; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * 到达车站名称
     */
    DEST_STATION_NAME((short)8, "destStationName");
  ...
  private static final _Fields optionals[] = {_Fields.TO_STATION_ID,_Fields.DEPART_DATEYYYY_MMDD,_Fields.RT_ORDER_ID,_Fields.RT_ORDER_CODE,_Fields.INCLUDE_PKG,_Fields.DEST_STATION_NAME};
  ...
  static {
    ...
    tmpMap.put(_Fields.INCLUDE_PKG, new org.apache.thrift.meta_data.FieldMetaData("includePkg", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.DEST_STATION_NAME, new org.apache.thrift.meta_data.FieldMetaData("destStationName", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public QueryBusReq(QueryBusReq other) {
    ...
    if (other.isSetDestStationName()) {
      this.destStationName = other.destStationName;
    }
  }
   ...
   * 到达车站名称
   */
  public QueryBusReq setDestStationName(String destStationName) {
    this.destStationName = destStationName;
    return this;
  }

  public void unsetDestStationName() {
    this.destStationName = null;
  }

  /** Returns true if field destStationName is set (has been assigned a value) and false otherwise */
  public boolean isSetDestStationName() {
    return this.destStationName != null;
  }

  public void setDestStationNameIsSet(boolean value) {
    if (!value) {
      this.destStationName = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DEST_STATION_NAME:
      if (value == null) {
        unsetDestStationName();
      } else {
        setDestStationName((String)value);
      }
      break;
  ...
  public boolean equals(QueryBusReq that) {
    ...
    boolean this_present_destStationName = true && this.isSetDestStationName();
    boolean that_present_destStationName = true && that.isSetDestStationName();
    if (this_present_destStationName || that_present_destStationName) {
      if (!(this_present_destStationName && that_present_destStationName))
        return false;
      if (!this.destStationName.equals(that.destStationName))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_destStationName = true && (isSetDestStationName());
    list.add(present_destStationName);
    if (present_destStationName)
      list.add(destStationName);
  ...
  public int compareTo(QueryBusReq other) {
    ...
    lastComparison = Boolean.valueOf(isSetDestStationName()).compareTo(other.isSetDestStationName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDestStationName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.destStationName, other.destStationName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetDestStationName()) {
      if (!first) sb.append(", ");
      sb.append("destStationName:");
      if (this.destStationName == null) {
        sb.append("null");
      } else {
        sb.append(this.destStationName);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class QueryBusReqStandardScheme extends StandardScheme<QueryBusReq> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryBusReq struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 8: // DEST_STATION_NAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.destStationName = iprot.readString();
              struct.setDestStationNameIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryBusReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.destStationName != null) {
        if (struct.isSetDestStationName()) {
          oprot.writeFieldBegin(DEST_STATION_NAME_FIELD_DESC);
          oprot.writeString(struct.destStationName);
          oprot.writeFieldEnd();
        }
      }
