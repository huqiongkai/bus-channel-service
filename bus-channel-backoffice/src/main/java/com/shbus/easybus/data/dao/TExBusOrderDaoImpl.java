...
public class TExBusOrderDaoImpl implements TExBusOrderMapper {
	...
	@Override
	public List<TExBusOrder> selectDailyOrderList(String dailyDateyyyyMMdd) {
		return this.sqlSessionTemplate.selectList(
				"com.shbus.easybus.data.model.dao.TExBusOrderMapper.selectDailyOrderList", dailyDateyyyyMMdd);
	}

	@Override
	public List<TExBusOrder> selectOrderListByPage(Map<String, Object> paramMap) {
		return this.sqlSessionTemplate
				.selectList("com.shbus.easybus.data.model.dao.TExBusOrderMapper.selectOrderListByPage", paramMap);
	}
